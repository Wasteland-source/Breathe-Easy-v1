...
module.exports = async function(tag, guild, channel) {
  ...
  try { //Sends a random nice message to help encourage people
    ...
    console.log('\x1b[31m%s\x1b[0m', `${guild}:${tag} Encouragement command fail`);
    return;
  }
}
